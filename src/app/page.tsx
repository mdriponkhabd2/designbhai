...
import { useAdminData, PricingPackage } from "@/lib/admin-store";
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Pricing Packages Section - Design */}
      <section className="py-24 bg-muted/30 border-t border-border/50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-4xl font-headline font-bold">Design Packages</h2>
      ...
      {/* Pricing Packages Section - Website */}
      ...
      <section className="py-24 bg-[#0a2e1a] text-white relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 w-full h-full bg-grid-white/[0.03] -z-0 -translate-x-1/2 -translate-y-1/2" />
          ...
          <div className="mt-32 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 text-center">
            {[
              ...
              <div key={i} className="space-y-4 group">
                <div className="w-14 h-14 bg-white/5 rounded-full flex items-center justify-center mx-auto text-primary group-hover:scale-110 transition-transform duration-300 border border-white/5 group-hover:border-primary/30">
