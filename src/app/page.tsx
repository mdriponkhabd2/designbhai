...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* NEW Web Hosting Section - UPDATED TO GREEN THEME */}
      <section className="py-24 bg-[#051109] text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            <div className="space-y-8 animate-in fade-in slide-in-from-left-8">
              <Badge className="bg-primary/20 text-primary border-primary/30 px-4 py-1">Fast & Reliable Domain Hosting</Badge>
              ...
              <Button size="lg" className="bg-gradient-to-r from-primary to-accent hover:opacity-90 text-white rounded-full px-10 h-14 font-bold shadow-2xl shadow-primary/20" asChild>
            ...
            <div className="relative">
              <div className="relative aspect-video rounded-[2rem] overflow-hidden bg-slate-900/50 border border-white/10 p-8 flex items-center justify-center shadow-2xl backdrop-blur-sm">
                <Server className="w-32 h-32 text-primary/20 absolute -top-8 -right-8" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {data.hostingPackages.map((pkg) => (
              <Card key={pkg.id} className={`relative p-8 rounded-3xl bg-slate-900/40 border-white/10 hover:border-primary/50 transition-all duration-300 flex flex-col group ${pkg.isPopular ? 'ring-2 ring-primary shadow-2xl shadow-primary/20' : ''}`}>
                {pkg.isPopular && (
                  <div className="absolute top-0 right-0 bg-primary text-white text-[10px] font-bold px-4 py-1 rounded-bl-xl uppercase tracking-tighter">
                    ⭐ Popular Choice
                  </div>
                ...
                <Button className={`w-full rounded-xl h-12 font-bold ${pkg.isPopular ? 'bg-primary hover:bg-primary/90' : 'bg-white/10 hover:bg-white/20'}`} asChild>
                  <Link href={pkg.orderLink}>Order Now</Link>
                </Button>
              </Card>
            ))}
          ...
          <div className="mt-32 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 text-center">
            {[
              ...
              <div key={i} className="space-y-4">
                <div className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center mx-auto text-primary">
          ...
          {/* Hosting CTA Section */}
          <div className="mt-32 p-12 bg-gradient-to-r from-primary/10 to-accent/10 rounded-[3rem] border border-white/5 text-center space-y-8 backdrop-blur-xl">
            ...
            <Button size="lg" className="bg-white text-slate-950 hover:bg-slate-200 rounded-full px-12 h-14 font-bold" asChild>
